...
import Logo1 from '../../../assets/img/logo half.png'
import Logo2 from '../../../assets/img/logo half 2.png'
...
const Header = ({ open, handleDrawerOpen, headerTitle }) => {
  ...
  return (
    <AppBar position="fixed" open={open} style={{ backgroundColor: '#000', color: "white", boxShadow: "None" }} >
      <Toolbar>
        <IconButton
          color="inherit"
        ...
        <Typography variant="h4" noWrap component="div" onClick={redirectToHome} sx={{ flexGrow: 1, fontWeight: 'bolder' }} >
          ...
          <img src={Logo2} style={{width:"200px" , height:"40px"}}/>
          </div>
        </Typography>
        {isLoggedIn && (
