...
import DoctorTable from '../MUITable/ExpertTable';
                ...
                <div className="content mt-4" >
                    <div className="row">
                        ...
                        <div className="col-sm-8 col-9 text-right m-b-20">
                            <Link to="/doctors/add" >
                                <button style={{backgroundColor:"black" , color:"white" , border:"none" , outline:"none" , padding:"10px 15px" , borderRadius:"5px"}}><i className="fa fa-plus"></i> Add Expert</button>
                            </Link>
                        </div>
                    </div>
