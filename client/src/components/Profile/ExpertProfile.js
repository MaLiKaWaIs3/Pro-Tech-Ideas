...
function DoctorProfile() {
    ...
    const getdoctorById = async () => {
        ...
        const response = await axios.get(`http://localhost:3002/profile/doctor/`+doctorUserId);
    ...
    const updatedoctoruser = async (e) => {
        ...
        try {
            await axios.patch(`http://localhost:3002/profile/doctor/${doctorId}`, {
                firstName,
                lastName,
                username,
                email,
                            ...
                            <div className="col-lg-8 offset-lg-2">
                                <form id="editdoctorForm" name='editdoctorForm' onSubmit={updatedoctoruser}>
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                ...
                                                <input name="firstName" placeholder='Enter Your Name Here' className="form-control" type="text" required value={firstName} onChange={(event) => setFirstName(event.target.value)} />
                                            </div>
                                        </div>
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                    ...
                                    <div className="m-t-20 text-center">
                                        <button type="submit"style={{backgroundColor:"black" , color:"white" , border:"none" , outline:"none" , padding:"10px 15px" , borderRadius:"5px"}}>Update Profile</button>
                                    </div>
                                </form>
                            </div>
                        </div>
